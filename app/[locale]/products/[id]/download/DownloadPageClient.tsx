    ...
    versions: [
      {
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.3.1/DataWhere_1.3.1_x64-setup.exe',
            size: '7.6 MB',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.3.0/DataWhere_1.3.0_x64_zh-CN.msi',
            size: '0.4 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.3.1/DataWhere_1.3.1_universal.dmg',
            size: '11.4 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.3.0/DataWhere_1.3.0_amd64.deb',
            size: '7.7 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.3.0/DataWhere-1.3.0-1.x86_64.rpm',
            size: '7.8 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.3.1/DataWhere_1.3.1_amd64.AppImage',
            size: '11.2 MB',
        ...
        releaseNotes: [
          '新增达梦（DM）数据库支持，可在工作台中浏览 Schema、表结构、索引，执行 SQL 查询',
          '新增 SQL 编辑器组件，支持语法高亮和自动补全',
          '全局搜索结果支持跳转到达梦工作台并自动定位到对应表',
          '修复达梦 Schema 列表不显示 CREATE SCHEMA 创建的 schema 的问题',
          '修复达梦工作台展开字段和索引无数据的问题',
          '修复搜索跳转到达梦工作台时提示「该模版已失效」的问题',
        ],
      },
      {
        version: '1.2.9',
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.9/DataWhere_1.2.9_x64-setup.exe',
            size: '7.3 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'exe',
          ...
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.9/DataWhere_1.2.9_universal.dmg',
            size: '13 MB',
            requirements: 'macOS 10.15+',
            status: 'stable',
            format: 'dmg',
          ...
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.9/DataWhere_1.2.9_amd64.AppImage',
            size: '13 MB',
            requirements: '通用 Linux 发行版',
            status: 'stable',
            format: 'AppImage',
        ...
        releaseNotes: [
          'SQL 工作台新增「执行选中」按钮，支持选中部分 SQL 单独执行',
          'Ctrl+Enter 快捷键自动适配',
          '执行选中和执行全部按钮状态独立',
          '去掉快捷键提示文字',
        ],

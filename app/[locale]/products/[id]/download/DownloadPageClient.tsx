    ...
    versions: [
      {
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.5/DataWhere_1.2.5_x64-setup.exe',
            size: '7.3 MB',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.5/DataWhere_1.2.5_x64_zh-CN.msi',
            size: '2.5 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.5/DataWhere_1.2.5_universal.dmg',
            size: '10 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.5/DataWhere_1.2.5_amd64.deb',
            size: '10 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.5/DataWhere-1.2.5-1.x86_64.rpm',
            size: '10 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.5/DataWhere_1.2.5_amd64.AppImage',
            size: '10 MB',
        ...
        releaseNotes: [
          '在线激活：支持产品内选套餐、扫码支付、自动激活',
          '激活等级徽章：右上角展示当前套餐等级，点击可升级',
          '升级套餐：已激活用户可直接选择更高级套餐',
          '过期提醒：非永久套餐到期前自动提醒续期',
        ],
      },
      {

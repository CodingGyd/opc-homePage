      ...
      },
      {
        ...
        downloads: [
          ...
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.1/DataWhere_1.2.1_x86-setup.exe',
            size: '6.5 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'exe',
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.1/DataWhere_1.2.1_x86_zh-CN.msi',
            size: '9.4 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.1/DataWhere-1.2.1-1.x86_64.rpm',
            size: '12.5 MB',
            requirements: 'RHEL/CentOS/Fedora',
            status: 'stable',
            format: 'rpm',
        ...
        releaseNotes: [
          '新增 Elasticsearch 数据源支持（6.x、7.x、8.x）：索引浏览、文档搜索、Mapping 查看',
          '元数据同步自动发现索引并建立全文搜索索引',
          '搜索结果跳转工作台，支持从全局搜索直达指定索引',
        ],
      },
    ],
  },

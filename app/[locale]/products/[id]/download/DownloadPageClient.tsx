    ...
    versions: [
      {
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.3.0/DataWhere_1.3.0_x64-setup.exe',
            size: '7.3 MB',
          ...
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.3.0/DataWhere_1.3.0_universal.dmg',
            size: '13 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.3.0/DataWhere_1.3.0_amd64.AppImage',
            size: '13 MB',
        ...
        releaseNotes: [
          '数据源连接支持自定义连接参数（MySQL/PostgreSQL/Redis/OceanBase）',
          '新增运行时日志记录，错误和警告自动写入日志文件',
          '设置页面新增「打开日志目录」按钮，方便排查问题',
          '前端错误自动转发到后端日志',
        ],
      },
      {

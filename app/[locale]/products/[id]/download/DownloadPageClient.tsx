    ...
    versions: [
      {
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.4/DataWhere_1.2.4_x64-setup.exe',
            size: '7.2 MB',
          ...
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.4/DataWhere_1.2.4_x86-setup.exe',
            size: '6.5 MB',
          ...
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.4/DataWhere_1.2.4_universal.dmg',
            size: '22 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.4/DataWhere_1.2.4_amd64.AppImage',
            size: '88 MB',
        ...
        releaseNotes: [
          '修复 MySQL/Oracle 模版库跳转工作台无法正确回显目标对象',
          '修复应用内更新下载报错「Download URL is not from a trusted domain」',
        ],
      },
      {
        version: '1.2.3',
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.3/DataWhere_1.2.3_x64-setup.exe',
            size: '7.2 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'exe',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.3/DataWhere_1.2.3_x64_zh-CN.msi',
            size: '10.6 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.3/DataWhere_1.2.3_x86-setup.exe',
            size: '6.5 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'exe',
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.3/DataWhere_1.2.3_x86_zh-CN.msi',
            size: '9.4 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.3/DataWhere_1.2.3_universal.dmg',
            size: '22 MB',
            requirements: 'macOS 10.15+',
            status: 'stable',
            format: 'dmg',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.3/DataWhere_1.2.3_amd64.deb',
            size: '12.7 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.3/DataWhere-1.2.3-1.x86_64.rpm',
            size: '12.7 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.3/DataWhere_1.2.3_amd64.AppImage',
            size: '88 MB',
            requirements: '通用 Linux 发行版',
            status: 'stable',
            format: 'AppImage',
        ...
        releaseNotes: [
          '修复暗黑模式下多处样式异常',
          '修复 MySQL/OceanBase 模版跳转工作台无法正确回显',
          '修复多工作台 Tab 重启后页面空白',
          '未激活用户数据源限制调整为 1 个',
        ],
      },
      {
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.2/DataWhere_1.2.2_x64-setup.exe',
            size: '7.2 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'exe',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.2/DataWhere_1.2.2_x64_zh-CN.msi',
            size: '1.2 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.2/DataWhere_1.2.2_x86-setup.exe',
            size: '6.5 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'exe',
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.2/DataWhere_1.2.2_x86_zh-CN.msi',
            size: '9.4 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.2/DataWhere_1.2.2_universal.dmg',
            size: '8.5 MB',
            requirements: 'macOS 10.15+',
            status: 'stable',
            format: 'dmg',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.2/DataWhere_1.2.2_amd64.deb',
            size: '8.5 MB',
            requirements: 'Debian/Ubuntu',
            status: 'stable',
            format: 'deb',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.2/DataWhere-1.2.2-1.x86_64.rpm',
            size: '8.5 MB',
            requirements: 'RHEL/CentOS/Fedora',
            status: 'stable',
            format: 'rpm',
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.2/DataWhere_1.2.2_amd64.AppImage',
            size: '8.5 MB',
            requirements: '通用 Linux 发行版',
            status: 'stable',
            format: 'AppImage',
        ...
        releaseNotes: [
          '模版库系统：收藏所有数据源类型的常用对象，一键跳转恢复上下文',
          '全局搜索对话框、搜索历史记录与搜索建议',
          'Tab 标签页拖拽排序、连接状态指示器',
          '数据源按环境筛选、健康检查',
        ],

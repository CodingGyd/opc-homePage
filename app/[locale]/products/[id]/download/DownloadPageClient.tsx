        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.6/DataWhere_1.2.6_x64-setup.exe',
            size: '7.3 MB',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.6/DataWhere_1.2.6_x64_zh-CN.msi',
            size: '0.4 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.6/DataWhere_1.2.6_universal.dmg',
            size: '7.8 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.6/DataWhere_1.2.6_amd64.deb',
            size: '7.7 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.6/DataWhere-1.2.6-1.x86_64.rpm',
            size: '7.8 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.6/DataWhere_1.2.6_amd64.AppImage',
            size: '7.9 MB',

    ...
    versions: [
      {
        ...
        downloads: [
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.9/DataWhere_1.2.9_x64_zh-CN.msi',
            size: '0.4 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.9/DataWhere_1.2.9_amd64.deb',
            size: '7.7 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.9/DataWhere-1.2.9-1.x86_64.rpm',
            size: '7.8 MB',

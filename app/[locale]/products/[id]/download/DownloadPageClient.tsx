    ...
    versions: [
      {
        ...
        downloads: [
          ...
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.0/DataWhere_1.2.0_x86-setup.exe',
            size: '6.4 MB',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.0/DataWhere_1.2.0_x86_zh-CN.msi',
            size: '9.2 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.2.0/DataWhere-1.2.0-1.x86_64.rpm',
            size: '12.5 MB',
        ...
        releaseNotes: [
          '新增 SQL Server 数据源支持（2012 ~ 2022）：元数据同步、只读 SQL 查询、DDL 查看',
          '关于弹窗新增问题反馈入口',
          'SQL Server 版本号展示优化',
        ],
      },
      {
        ...
        downloads: [
          ...
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.9/DataWhere_1.1.9_x86-setup.exe',
            size: '5.9 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'exe',
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.9/DataWhere_1.1.9_x86_zh-CN.msi',
            size: '4.5 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.9/DataWhere-1.1.9-1.x86_64.rpm',
            size: '12 MB',
            requirements: 'RHEL/CentOS/Fedora',
            status: 'stable',
            format: 'rpm',
        ...
        releaseNotes: [
          '新增 Oracle 数据源支持（11g、12c、19c、23ai）：元数据同步、只读 SQL 查询、DDL 查看',
        ],
      },
      {
        version: '1.1.8',
        ...
        downloads: [
          ...
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.8/DataWhere_1.1.8_x86-setup.exe',
            size: '5.8 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'exe',
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.8/DataWhere_1.1.8_x86_zh-CN.msi',
            size: '8.4 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.8/DataWhere-1.1.8-1.x86_64.rpm',
            size: '12 MB',
            requirements: 'RHEL/CentOS/Fedora',
            status: 'stable',
            format: 'rpm',
        ...
        releaseNotes: [
          '新增 RabbitMQ 数据源支持（3.8.x ~ 4.2.x）：队列列表、消息查看、交换机浏览',
          '数据源测试连接优化：认证错误现在精确提示，不再误报为网络问题',
        ],
      },
      {
        version: '1.1.7',
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.7/DataWhere_1.1.7_x64-setup.exe',
            size: '6.3 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'exe',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.7/DataWhere_1.1.7_x64_zh-CN.msi',
            size: '9.3 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.7/DataWhere_1.1.7_x86-setup.exe',
            size: '4.9 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'exe',
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.7/DataWhere_1.1.7_x86_zh-CN.msi',
            size: '4.8 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.7/DataWhere_1.1.7_universal.dmg',
            size: '16 MB',
            requirements: 'macOS 10.15+',
            status: 'stable',
            format: 'dmg',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.7/DataWhere_1.1.7_amd64.deb',
            size: '11 MB',
            requirements: 'Debian/Ubuntu',
            status: 'stable',
            format: 'deb',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.7/DataWhere-1.1.7-1.x86_64.rpm',
            size: '11 MB',
            requirements: 'RHEL/CentOS/Fedora',
            status: 'stable',
            format: 'rpm',
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.7/DataWhere_1.1.7_amd64.AppImage',
            size: '16 MB',
            requirements: '通用 Linux 发行版',
            status: 'stable',
            format: 'AppImage',
        ...
        releaseNotes: [
          '新增 RocketMQ 数据源支持（4.x ~ 5.x）：Topic 列表、消息查看、消费组管理',
          '修复 MySQL/PostgreSQL/OceanBase 工作台 SELECT 查询含 update_time 等列名时误报「禁止执行写操作」的问题',
          '首页统计卡片将 Kafka Topic 和 RocketMQ Topic 合并为统一的「消息主题」展示',
        ],
      },
    ],
  },

    ...
    versions: [
      {
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.3/DataWhere_1.1.3_x64-setup.exe',
            size: '5.7 MB',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.3/DataWhere_1.1.3_x64_zh-CN.msi',
            size: '8.3 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.3/DataWhere_1.1.3_x86-setup.exe',
            size: '5.1 MB',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.3/DataWhere_1.1.3_x86_zh-CN.msi',
            size: '7.4 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.3/DataWhere_1.1.3_universal.dmg',
            size: '17.6 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.3/DataWhere_1.1.3_amd64.deb',
            size: '10.4 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.3/DataWhere-1.1.3-1.x86_64.rpm',
            size: '10.4 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.3/DataWhere_1.1.3_amd64.AppImage',
            size: '80.0 MB',
        ...
        releaseNotes: [
          'PostgreSQL 工作台支持视图和物化视图的浏览、搜索和 DDL 查看',
          '搜索结果类型标签国际化',
          '搜索跳转工作台时自动展开对应分类目录',
          '修复 Redis 5.0.14.1 元数据同步 UTF-8 转换错误',
          '修复重启应用后搜索无法找到数据的问题',
          '修复物化视图字段列表为空的问题',
          '修复 varchar 类型显示为「character varying」的问题',
        ],
      },
      {
        version: '1.1.2',
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.2/DataWhere_1.1.2_x64-setup.exe',
            size: '5.7 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'exe',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.2/DataWhere_1.1.2_x64_zh-CN.msi',
            size: '8.3 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.2/DataWhere_1.1.2_x86-setup.exe',
            size: '5.1 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'exe',
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.2/DataWhere_1.1.2_x86_zh-CN.msi',
            size: '7.4 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.2/DataWhere_1.1.2_universal.dmg',
            size: '17.5 MB',
            requirements: 'macOS 10.15+',
            status: 'stable',
            format: 'dmg',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.2/DataWhere_1.1.2_amd64.deb',
            size: '10.3 MB',
            requirements: 'Debian/Ubuntu',
            status: 'stable',
            format: 'deb',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.2/DataWhere-1.1.2-1.x86_64.rpm',
            size: '10.3 MB',
            requirements: 'RHEL/CentOS/Fedora',
            status: 'stable',
            format: 'rpm',
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.2/DataWhere_1.1.2_amd64.AppImage',
            size: '85.4 MB',
            requirements: '通用 Linux 发行版',
            status: 'stable',
            format: 'AppImage',

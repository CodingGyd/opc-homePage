    ...
    versions: [
      {
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.1/DataWhere_1.1.1_x64-setup.exe',
            size: '5.7 MB',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.1/DataWhere_1.1.1_x64_zh-CN.msi',
            size: '8.3 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.1/DataWhere_1.1.1_x86-setup.exe',
            size: '5.1 MB',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.1/DataWhere_1.1.1_x86_zh-CN.msi',
            size: '7.4 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.1/DataWhere_1.1.1_universal.dmg',
            size: '17.5 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.1/DataWhere_1.1.1_amd64.deb',
            size: '10.3 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.1/DataWhere-1.1.1-1.x86_64.rpm',
            size: '10.3 MB',
          ...
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.1.1/DataWhere_1.1.1_amd64.AppImage',
            size: '85.4 MB',
        ...
        releaseNotes: [
          '新增 PostgreSQL 数据源支持（12.x ~ 17.x），包含数据库、Schema、表三级浏览和只读查询工作台',
          '数据源架构升级为插件化设计，后续新增数据源类型将更快、更稳定',
          '修复部分情况下支持者激活码导入后提示"签名无效"的问题',
          '修复手动安装新版本后数据源配置可能丢失的问题',
        ],
      },
      {
        version: '1.0.9',
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.9/DataWhere_1.0.9_x64-setup.exe',
            size: '5.4 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'exe',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.9/DataWhere_1.0.9_x64_zh-CN.msi',
            size: '7.8 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.9/DataWhere_1.0.9_x86-setup.exe',
            size: '4.9 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'exe',
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.9/DataWhere_1.0.9_x86_zh-CN.msi',
            size: '6.9 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.9/DataWhere_1.0.9_universal.dmg',
            size: '17 MB',
            requirements: 'macOS 10.15+',
            status: 'stable',
            format: 'dmg',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.9/DataWhere_1.0.9_amd64.deb',
            size: '9.8 MB',
            requirements: 'Debian/Ubuntu',
            status: 'stable',
            format: 'deb',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.9/DataWhere-1.0.9-1.x86_64.rpm',
            size: '9.8 MB',
            requirements: 'RHEL/CentOS/Fedora',
            status: 'stable',
            format: 'rpm',
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.9/DataWhere_1.0.9_amd64.AppImage',
            size: '85 MB',
            requirements: '通用 Linux 发行版',
            status: 'stable',
            format: 'AppImage',
      ...
      },
      {
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.8/DataWhere_1.0.8_x64-setup.exe',
            size: '5.4 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'exe',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.8/DataWhere_1.0.8_x64_zh-CN.msi',
            size: '7.8 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.8/DataWhere_1.0.8_x86-setup.exe',
            size: '4.9 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'exe',
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.8/DataWhere_1.0.8_x86_zh-CN.msi',
            size: '6.9 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.8/DataWhere_1.0.8_universal.dmg',
            size: '17 MB',
            requirements: 'macOS 10.15+',
            status: 'stable',
            format: 'dmg',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.8/DataWhere_1.0.8_amd64.deb',
            size: '9.8 MB',
            requirements: 'Debian/Ubuntu',
            status: 'stable',
            format: 'deb',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.8/DataWhere-1.0.8-1.x86_64.rpm',
            size: '9.8 MB',
            requirements: 'RHEL/CentOS/Fedora',
            status: 'stable',
            format: 'rpm',
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.8/DataWhere_1.0.8_amd64.AppImage',
            size: '85 MB',
            requirements: '通用 Linux 发行版',
            status: 'stable',
            format: 'AppImage',
        ...
        releaseNotes: [
          '首次安装引导页：全新安装后自动展示欢迎介绍和快速上手引导',
          '版本更新日志弹窗：应用更新后首次启动自动弹出更新日志',
          '无缝覆盖更新：应用内更新静默覆盖安装，无需卸载旧版本',
          '安装器智能识别：自动区分首次安装和版本升级场景',
        ],
      },
      {
        version: '1.0.7',
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.7/DataWhere_1.0.7_x64-setup.exe',
            size: '5.9 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'exe',
          ...
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.7/DataWhere_1.0.7_x64_zh-CN.msi',
            size: '8.6 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.7/DataWhere_1.0.7_x86-setup.exe',
            size: '5.4 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'exe',
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.7/DataWhere_1.0.7_x86_zh-CN.msi',
            size: '7.6 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.7/DataWhere_1.0.7_universal.dmg',
            size: '18.2 MB',
            requirements: 'macOS 10.15+',
            status: 'stable',
            format: 'dmg',
          ...
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.7/DataWhere_1.0.7_amd64.deb',
            size: '10.7 MB',
            requirements: 'Debian/Ubuntu',
            status: 'stable',
            format: 'deb',
          ...
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.7/DataWhere-1.0.7-1.x86_64.rpm',
            size: '10.7 MB',
            requirements: 'RHEL/CentOS/Fedora',
            status: 'stable',
            format: 'rpm',
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.7/DataWhere_1.0.7_amd64.AppImage',
            size: '85.6 MB',
            requirements: '通用 Linux 发行版',
            status: 'stable',
            format: 'AppImage',
      ...
      },
      {
        ...
        downloads: [
          {
            platform: 'Windows',
            arch: 'exe (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.6/DataWhere_1.0.6_x64-setup.exe',
            size: '5.9 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'exe',
          },
          {
            platform: 'Windows',
            arch: 'msi (64-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.6/DataWhere_1.0.6_x64_zh-CN.msi',
            size: '8.6 MB',
            requirements: 'Windows 10+ (64-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'Windows',
            arch: 'exe (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.6/DataWhere_1.0.6_x86-setup.exe',
            size: '5.4 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'exe',
          },
          {
            platform: 'Windows',
            arch: 'msi (32-bit)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.6/DataWhere_1.0.6_x86_zh-CN.msi',
            size: '7.7 MB',
            requirements: 'Windows 10+ (32-bit)',
            status: 'stable',
            format: 'msi',
          },
          {
            platform: 'macOS',
            arch: 'Universal',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.6/DataWhere_1.0.6_universal.dmg',
            size: '18.2 MB',
            requirements: 'macOS 10.15+',
            status: 'stable',
            format: 'dmg',
          },
          {
            platform: 'Linux',
            arch: 'deb (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.6/DataWhere_1.0.6_amd64.deb',
            size: '10.7 MB',
            requirements: 'Debian/Ubuntu',
            status: 'stable',
            format: 'deb',
          },
          {
            platform: 'Linux',
            arch: 'rpm (x86_64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.6/DataWhere-1.0.6-1.x86_64.rpm',
            size: '10.7 MB',
            requirements: 'RHEL/CentOS/Fedora',
            status: 'stable',
            format: 'rpm',
          },
          {
            platform: 'Linux',
            arch: 'AppImage (amd64)',
            url: 'https://gydblog2.su.bcebos.com/files/datawhere/v1.0.6/DataWhere_1.0.6_amd64.AppImage',
            size: '85.6 MB',
            requirements: '通用 Linux 发行版',
            status: 'stable',
            format: 'AppImage',
        ...
        releaseNotes: [
          'MySQL 工作台结果表支持右键菜单（复制单元格/行/表）',
          'MySQL 工作台 SQL 编辑器支持拖拽调整高度',
          'MySQL 工作台结果表列头悬停显示列类型和注释',
          '系统托盘图标悬停显示应用名称提示',
          '应用数据存储在安装目录而非 AppData',
          '数据库连接添加超时处理和错误显示',
        ],
      },
      {
